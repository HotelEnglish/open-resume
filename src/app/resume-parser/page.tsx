...
const 默认文件Url = RESUME_EXAMPLES[0]["fileUrl"];
export default function 简历解析器() {
        ...
        <div className="flex px-6 text-gray-900 md:col-span-3 md:h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
          ...
          <section className="max-w-[600px] grow">
            ...
            <Paragraph smallMarginTop={true}>
              这个演示区域展示了OpenResume简历解析器及其从简历PDF中提取信息的能力。点击下面的PDF示例以观察不同的解析结果。
            </Paragraph>
            ...
            <Paragraph>
              您也可以在下方<span className="font-semibold">添加您的简历</span>，查看类似招聘管理系统（ATS）在求职申请中对您简历的解析效果如何。解析出的信息越多，说明简历格式越好、越易读。至少确保姓名和邮箱地址被准确地解析出来是有益的。
            </Paragraph>
            <div className="mt-3">
              <ResumeDropzone
